...
import { upcoming_movies } from '@/constants/endpoints';
...
const ComingMovies = () => {
    ...
    useEffect(() => {
        getMovies(upcoming_movies, currentPage)

    }, [currentPage])
    return (
        <MoviesLayout actionNext={goToNextPage} actionPrev={goToPrevPage} title="Upcoming Movies">
            {
                loading ? <Loader /> : (
